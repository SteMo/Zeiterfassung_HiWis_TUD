...
//                                    },                
                        ...
                        listeners: {
                        	...
                        	create: function(form, data){                        		
                        		...
                        		Ext.Msg.alert('Status', data.givenname + " " + data.surname + " wurde erfolgreich in der Datenbank als " + data.position + " angelegt!");
                            }
                        },    
            	                                  ...
            	                                  items: [
            	                   					  ...
            	                   					  }, 
            	                                      {
            	                                          ...
            	                                          handler: function(){
            	                                              ...
            	                                              Ext.Msg.confirm('Löschen bestätigen', 'Soll ' + selection.data.name + ' wirklich gelöscht werden?',
	            	                                            		  		function(btn, text){
            	                                            	    				if (btn == 'yes'){
            	                      	                                              if (selection) {    
